...
type UpdatePostPacketAck struct {
	IsUpdateOk string `protobuf:"bytes,1,opt,name=isUpdateOk,proto3" json:"isUpdateOk,omitempty"`
}
...
func (m *UpdatePostPacketAck) GetIsUpdateOk() string {
	if m != nil {
		return m.IsUpdateOk
	}
	return ""
...
var fileDescriptor_d544876606a92415 = []byte{
	...
	,
}
...
func (m *UpdatePostPacketAck) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.IsUpdateOk) > 0 {
		i -= len(m.IsUpdateOk)
		copy(dAtA[i:], m.IsUpdateOk)
		i = encodeVarintPacket(dAtA, i, uint64(len(m.IsUpdateOk)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *UpdatePostPacketAck) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field IsUpdateOk", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.IsUpdateOk = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipPacket(dAtA[iNdEx:])
